    ...
    <Wrapper>
      ...
      <section class="myclass">
          ...
          <div class="">
            <div class="col-lg-10">
              ...
              >
                ...
                <span
                style={{fontWeight:"500",fontSize:"16px",lineHeight:"19px",color:"#4E4E4E",marginTop:'200px',marginLeft:'0px' ,padding:'20px,20px,20px,px'}}>No Items added to Cart.
        ...
        <div class="alignment-order">
                ...
                style={{ display: "flex", justifyContent: "space-around" }}>
        <button class="continue" onClick={handleClick}>
        <a style={{ textDecoration: "none", color: "white",textAlign:"center" }} >Back to Add Items</a></button>
        </div>
        </div>
        <br></br>
        <br></br>
