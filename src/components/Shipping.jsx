      ...
      <Wrapper>
        ...
        <div className="row container testing">
                  ...
                  <section class="shipping">
                    <form>
                      ...
                      <div class="col">
                        ...
                        {isMobile && <ContinueBackBTN SaveUser={SaveUser} />}
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-6 col-sm-12">
                            ...
                            <p>
                              Phone numbers shall be used only for delivery
                              purposes.
                            </p>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-6 col-sm-12 offset-lg-4">
                            ...
                            />
                            <p>
                              We will send an order confirmation on this email.
                            </p>
                            <div style={{ color: "red", fontsize: "12px" }}>
                              {emailerror}
                            </div>
          ...
          <div class="col col-md-4 padding-0 product-cart">
            <Product_Cart onClick={SaveUser} visibility={"visible"} />
          </div>
        </div>
