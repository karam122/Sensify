...
function Cart({ id1, price, amount2, main_header, desc, list, pics }) {
  ...
  const handleClick = () => {
    var User_ID = localStorage.getItem("local_id_store");
    var obj = localStorage.getItem("userid-local_storage");
    // console.log("Local Storage Check from navbar: ", obj, stri);
    if (User_ID !== null) {
  ...
  const { increasei, decreased, addToCart } = useGlobalContext();
  return (
    <Wrapper>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="">
                      ...
                      <span>
                        <img
                          src={sub}
                          class="mb-dp"
                          onClick={() => decreased(id1, amount2)}
                        />
                        &emsp;{amount2}&emsp;
                        <img
                          src={add}
                          class="mb-dn"
                          onClick={() => increasei(id1, amount2)}
                        />
                      </span>
                    </div>
                  </div>
                  ...
                  <div class="btn-alignment">
                    ...
                    >
                      <div class="">
                        <button
                          class="btn-add-to-cart ripple"
                          /*onClick={() => increase(id)}*/ onClick={() =>
                            addToCart(id1, amount2)
                          }
                          onChange="myFunction()"
                        >
                          {/* <script>
