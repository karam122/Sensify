            ...
            <div class="row order">
              <div class="col-lg-3 col-md-4">
                <ul class="list-unstyled phone ">
                  ...
                  <li style={{position:'relative',top:'14px'}}>
              ...
              <div class="col-lg-3 col-md-4 desktop">
                <p>Quick Links</p>
                <ul class="list-unstyled list ">
                <a className="anchor" onClick={(e)=>{navigate('/')}} aria-current="page" href="#about"><li>
                  
                  About
                  
                  </li></a>
                <a className="anchor" onClick={(e)=>{navigate('/')}} aria-current="page" href="#tutorials"><li>
              ...
              <div class="col-lg-3 col-md-4 desktop">
                ...
                <a className="anchor" onClick={(e)=>{navigate('/')}} aria-current="page" href="#shop"><li>
                    Shop
                  </li></a>
                  <a className="anchor" onClick={(e)=>{navigate('/')}} aria-current="page" href="#"><li>
                    Sensify Inc
                  </li></a>
                </ul>
              </div>
              <div class="col-lg-3 col-md-12 p-0">
                ...
                <div class="input-group " style={{position:'relative',top:"10px"}}>
                  ...
                  />
                  <button class="btn btn-success" type="submit" style={{height:'48px',position:'relative',top:'7.5px',zIndex:'0'}}>
                    <img src={input_arrow}  />
                  </button>
                </div>
